                ...
                for (int i = 0; i < attachments.length(); i++) {
                    ...
                    if (type.equals("photo")) {
                        ...
                        if (ext.equals("gif")) {
                           ...
                           // object1 = attachment.getJSONObject("doc").getJSONObject("preview").getJSONObject("audio_msg");
                            ...
                            linearLayout.setOnClickListener( new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    try {
                                            ...
                                            String uri = object.getJSONObject("preview").getJSONObject("audio_msg").getString("link_mp3");
