...
public class Method {
    ...
    public static HashMap<String, String> getmId(String name) {
        ...
        try {
            ...
            Cursor c = ApplicationName.getDb().query("audio_stickers", null, "name=?", selectionArgs, null, null, null);
            if (c != null && c.moveToFirst()) {

                int id = c.getColumnIndex("owner_id");

                do {
                    _return.put("owner_id", c.getString(id));
    ...
    public static void addid(int id) {
        ...
        ApplicationName.getDb().insert("chatt", null, contentValues);
        try {
            ApplicationName.getDb().setTransactionSuccessful();
        } finally {
            ApplicationName.getDb().endTransaction();
    ...
    public static void addischat(int iss) {
        ApplicationName.getDb().beginTransaction();
        ContentValues contentValues = new ContentValues();
        contentValues.put("chat", iss);
    ...
    public static int getid() {
        ...
        try {
            ...
            Cursor c = ApplicationName.getDb().query("chatt", null, null, null, null, null, null);
            if (c != null && c.moveToFirst()) {

                int id = c.getColumnIndex("mid");
    ...
    public static void addowner(String own, String name) {
        String[] selectionArgs;
        selectionArgs = new String[]{name};
        ApplicationName.getDb().beginTransaction();
        ContentValues contentValues = new ContentValues();
        contentValues.put("owner_id", own);


        ApplicationName.getDb().update("audio_stickers", contentValues, "name=?", selectionArgs);
        try {
            ApplicationName.getDb().setTransactionSuccessful();
        } finally {
            ApplicationName.getDb().endTransaction();
    ...
    public static String geturl(String name) {
        ...
        try {
            ...
            if (c != null && c.moveToFirst()) {
                ...
                int id = c.getColumnIndex("url");

                do {
                    _return = c.getString(id);
