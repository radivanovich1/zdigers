...
public class ChatActivity extends Fragment {
                ...
                if (!message.equals("") || attachmentsAdapter.items.size() != 0) {
                  ...
                  //  HashMap<String, String> values = null;
                    ...
                    //} catch (ExecutionException e) {
                      //  e.printStackTrace();
                   // }
                   // String m_id = values.get("id");
                    //String owner_id = values.get("owner_id");





                    String attachmentsIds =attachmentsAdapter.getIds(); //"doc"+owner_id+"_"+m_id;//attachmentsAdapter.getIds();
    ...
    public void send(final HashMap<String, Object> post, final int mgsId) {
